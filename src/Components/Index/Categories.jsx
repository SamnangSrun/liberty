...
const Categories = () => {
  return (
    <div className="container mx-auto p-6">
      <p className="text-1xl font-bold text-center text-[#102249] mb-4">Books</p>
      <h1 className="text-3xl font-bold text-center mb-4">Categories</h1>
      <p className="text-center text-[#667085] mb-8">Here you will find different types of books available at Liberty Library.</p>
      <div className="grid grid-cols-2 gap-6">
        {categories.map((category) => (
          <div key={category.title} className="relative  transform hover:scale-105 transition-transform duration-300  bg-white rounded-lg shadow-lg overflow-hidden">
            <img 
              src={category.image} 
              alt={category.title} 
